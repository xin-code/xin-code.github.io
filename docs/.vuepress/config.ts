...
// const DOMAIN_NAME = 'xx.com' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    bodyBgImg: ['/img/bg.jpeg'], // body背景大图，默认无。 单张图片 String | 多张图片 Array, 多张图片时隔bodyBgImgInterval切换一张。
    ...
    author: {
      name: 'Xin', // 必需
      link: 'https://github.com/xin-code', // 可选的
    },

    // 博主信息 (显示在首页侧边栏)
    blogger: {
      avatar: 'https://avatars.githubusercontent.com/u/32591789?v=4',
      name: 'Xin',
      slogan: '面朝大海,春暖花开',
    },
    ...
    social: {
      ...
      icons: [
        ...
        },
        {
          iconClass: 'icon-erji',
          title: '听音乐',
          link: 'https://music.163.com/#/playlist?id=327644082',
        },
      ],
    },
